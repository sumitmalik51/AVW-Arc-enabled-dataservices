...
In this exercise, you will create a **Azure SQL managed instance - Azure Arc**

## Task 1: Create SQL Managed Instance 

1. In the Azure Arc Data Controller dashboard, click on **+ New Instance**.

1. From the deployment options blade, select **Azure SQL managed instance - Azure Arc**. Accept the Privacy and license terms and click **Select** at the button.
...
## Task 6: View SQL MI resource and SQL Mi logs in Azure Portal.
   ...
   1. Open CMD and login to the Data controller using the below command.
...
## Task 7: Monitor with Azure Data Studio
  ...
  ## View the Visualization and metric using grafana grafh
